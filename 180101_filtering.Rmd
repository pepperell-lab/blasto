---
title: "Overlapping ROH Variant Filtering"
author: "Mary O'Neill"
date: "January 1 2018"
...
ROH were calculated with BCFTOOLS and GARLIC and the union was used. Variants falling within these regions were extracted and annotated with VEP. 
...
y <- dat %>% separate(col=INFO, into=INTO, sep = "\\|", convert=TRUE)

glimpse(y)


save(y, file="C:/Users/Mary/Desktop/roh.Rdata")
```
